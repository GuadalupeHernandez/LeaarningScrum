...
import com.herprogramacion.scrum.quiz.Grafica;
import com.herprogramacion.scrum.scrumCards.CardSelectorActivity;
    ...
    private void seleccionarItem(MenuItem itemDrawer) {
        ...
        switch (itemDrawer.getItemId()) {
            ...
            case R.id.item_juego:
                startActivity(new Intent(this, CardSelectorActivity.class));
                break;
            case R.id.item_grafica:
                startActivity(new Intent(this, Grafica.class));
                break;
            case R.id.item_grafica_dos:
